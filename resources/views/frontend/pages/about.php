        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                ...
                <section>
                    ...
                    <img src="https://smartsdeal.com/front/images/About-Us.png" class="rounded-2" width="100%" alt="about Us">

                    <div class="about-us mt-3">
                        <h3 class="fw-bold fs-3">CONCERNING SMARTSDEAL</h3>
                        <p style="line-height: 30px;">
                            We are a one-stop shop where you can find everything you need to make every shopping trip a lot of fun for you. We can tell you everything you need to know about discounts, special offers, deals, and amazing price cuts.<br>
                            You don't have to spend extra time and money figuring out what to buy and where to buy it anymore.
                        </p>
                        <h4>WHAT IS SMARTSDEAL?</h4>
                        <p style="line-height: 35px;">
                            We're a place where you can spend less time, energy, and, most importantly, cash, hence our name. We have everything you need to satisfy your shopping itch without breaking the bank. You may rest easy knowing that we have exciting deals on every brand and store in the world.<br>

                            Find out where you may get certain things at a bargain. We put in a lot of time and effort as writers and researchers to make sure you get the best of both worlds.
                        </p>
                        <div class="mb-3">
                            <h3 class="fw-bold fs-3">WHY GO WITH US?</h3>
                            <p>Since you've probably seen hundreds of other bargain sites online, you may be wondering what makes us special. This is what sets us apart from the competition:</p>
                        </div>
                        <div class="mb-3">
                            <h3 class="fw-bold fs-3">AUTHENTICITY</h3>
                            <p>You can always use one of our vouchers. A reward is guaranteed at all times if the instructions on the website are followed. There are no additional or obscure requirements.</p>
                        </div>
                        <div class="mb-3">
                            <h3 class="fw-bold fs-3">PRIORITY</h3>
                            <p>We put the needs of our customers first. What good is it if our customers aren't happy with our service, even though we have a unique reward system? To help you out as much as possible, we constantly give our all.</p>
                        </div>
                    </div>
                </section>
                <!--------- Section::End ------------->
