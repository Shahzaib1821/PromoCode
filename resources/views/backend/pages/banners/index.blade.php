            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('banners.create') }}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2">
                        ...
                        <tbody>
                            @foreach ($banners as $banner)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('banners.edit', $banner->id) }}" class="btn btn-soft-info waves-effect waves-light">
