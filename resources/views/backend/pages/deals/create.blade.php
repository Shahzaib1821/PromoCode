...
@section('content')
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Create New Deal</h4>
                    ...
                    <form action="{{ route('deals.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-check form-check-inline">
                                    <input type="checkbox" class="form-check-input" id="deal_exclusive"
                                        name="deal_exclusive" value="1" {{ old('deal_exclusive') ? 'checked' : '' }}>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-12">
                                    <div>
                                        <button type="submit" class="btn btn-primary w-md">Add Deal</button>
                                    </div>
                                </div>
                            </div>
                        </div>
